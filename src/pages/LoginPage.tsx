...
export const LoginPage = ({ navigation }: NativeStackScreenProps<RootStackParamList, 'Login'>) => {
    ...
    return (
        <View style={{ backgroundColor: colors.accent400, flex: 1 }}>
            ...
            <View style={{
                ...
                <Text style={{ fontSize: 22, fontWeight: '600', fontFamily: 'Lato-Regular', }}>Вход</Text>
                ...
                <TouchableOpacity onPress={isLoginFields ? () => setLoginFields(false) : () => navigation.navigate('SuccessAuth')} style={{
                ...
                <Text style={{ textAlign: 'center', marginTop: 8, fontSize: 14, }}>
                    <TouchableOpacity  onPress={() => navigation.navigate('Registration')} ><Text style={{ color: '#67C23C', fontSize: 14, }}>
                    Зарегестрируйтесь
                    </Text>
                    </TouchableOpacity>
